...
def train_model(filter_density, pool_n_row, pool_n_col, dropout, nb_epoch, file_path_model):
    ...
    model_merged_1.fit([X_train_validation, X_train_validation, X_train_validation, X_train_validation, X_train_validation, X_train_validation],
                    Y_train_validation,
                    nb_epoch=nb_epoch,
                    batch_size=128)
...
if __name__ == '__main__':
    ...
    file_path_model = './qmLonUpf/laosheng/keras.cnn_jordi_mfccBands_2D_all_optim.h5'
