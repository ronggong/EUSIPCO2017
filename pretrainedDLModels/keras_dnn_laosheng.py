...
filename_train_set              = '../trainingData/train_set_laosheng_phonemeSeg_mfccBands_neighbor.pickle.gz'
filename_train_validation_set   = '../trainingData/train_set_all_laosheng_phonemeSeg_mfccBands_neighbor.pickle.gz'
filename_validation_set         = '../trainingData/validation_set_laosheng_phonemeSeg_mfccBands_neighbor.pickle.gz'
...
if __name__ == '__main__':
    ...
    model_1.save('./qmLonUpf/laosheng/keras.dnn_3_optim_mfccBands_neighbor_all.h5')
